...
public class Main {
    public static void main(String[] args) {
        ...
        Command comanda1 = new Plecare(new Autobuz("BMW"),123);
        Command comanda2 = new Plecare(new Autobuz("Mercedes"),10);

        operator.adaugaComanda(comanda1);
        operator.adaugaComanda(comanda2);
        operator.adaugaComanda(new Plecare(new Autobuz("Audi"),45));
