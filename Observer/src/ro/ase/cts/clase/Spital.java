...
public class Spital implements ISpital{
    ...
    public void notifica(String mesaj) {
        lista.forEach(pacient -> pacient.receptioneazaNotificare(mesaj+" de la spitalul "+this.nume));
    }
    ...
    public void notificaVirus(){
        this.notifica("Exista un virus nou care circula in zona");
    }
    public void notificaPandemie(){
        this.notifica("Exista o pandemie la nivel national");
    }
}
